  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    SlyderA(tipo="b").px-5.py-3.mb-5
      .row.justify-content-around.align-items-center.my-3.slyder-margin1
        .col-md-6.mb-4.mb-md-0
          h2 Estructurales
          p Son aquellas limitaciones que se derivan de los recursos físicos que demandan los puntos de venta para la comercialización, como no contar con locales comerciales o dotaciones operativas para la adecuación de los bienes o productos para la venta, tales como mobiliarios, estanterías, neveras, cuartos de refrigeración o congelación, elementos de movilización, entre otros. En estas limitaciones también se incluyen las carencias de personal entrenado y especializado en ventas y servicio al cliente, el cual demanda grandes cantidades de inversión, en aras de atender una demanda potencial o real. También se encuentran factores estructurales y de mayor alcance y relevancia, como lo son los aspectos geográficos, puesto que todo punto de venta y comercialización tiene un radio de acción limitado y no puede garantizar que los clientes lleguen a sus puntos, por tanto, no le es tan fácil desarrollarse estructuralmente, convirtiéndose esto en una limitación.      
        .col-md-6
          figure
            img(src='@/assets/curso/temas/tema1/t1-2.svg', alt='Texto que describa la imagen')

      .row.justify-content-around.align-items-center.slyder-margin
        .col-md-6.mb-4.mb-md-0
          h2 Dinámicas
          p Son aquellas limitaciones derivadas de la capacidad funcional de las ventas en sí, como contar con una fuerza de vendedores externos limitada, bajos niveles de capacitación y conocimiento del portafolio de productos, pocas condiciones comerciales de plazos, descuentos, administración de inventarios, no contar con operaciones de recambio, rudimentarios procesos de venta, falta de modernización tecnológica, malos esquemas de comunicación comercial con los clientes, no contar con un sistema de gestión de distribución y logística de inventarios, reducidos esquemas de publicidad, entre otras falencias.
        .col-md-6
          figure
    ...
    .row
      .col-lg-7.mb-5.mb-lg-0
        hr.linea.mb-0
        .b1.bloque-texto-b.color-secundario1.p-3
          .b1.bloque-texto-b__texto
            i.fas.fa-quote-left
            p.mb-0 Contar o desarrollar canales de distribución es de gran importancia para las empresas, pues por medio de agentes externos a la empresa, a los que se les denomina terceros, es posible que se conozcan las marcas y productos en regiones o lugares donde regularmente no llega el fabricante o la empresa, lo que de manera gradual se convertirá en ventas crecientes, aumentando en número los consumidores, con miras a establecerlos o fidelizarlos en el largo plazo; el propósito es que estos nuevos clientes o consumidores mantengan su interés y compren más los productos de la marca.
            br
            p.alineacion-text.text-bold (Paz, 2010).
            i.fas.fa-quote-right
      .col-lg-5.mb-5.mb-lg-0.mt-3
        img(src='@/assets/curso/temas/tema1/t1-6.svg', alt='Texto que describa la imagen')      

    .row.justify-content-center
      .col-lg-8.mb-5.mb-lg-0
        hr.linea.mb-0
        .b2.bloque-texto-b.color-secundario1.p-3
          .b2.bloque-texto-b__texto
            i.fas.fa-quote-left
            p.mb-0 Los canales permiten que las empresas que obtienen, elaboran y fabrican productos alimenticios, se puedan concentrar en su actividad principal sin invertir grandes esfuerzos corporativos en la distribución y venta efectiva, que son aspectos importantes, pero que pueden delegar a otras empresas especializadas en ventas y logística de distribución. Regularmente, estos empresarios de alimentos no poseen amplias capacidades de recursos para la distribución y venta en puntos propios que cubran grandes regiones o zonas, ya que esto les demanda grandes inversiones, adicionales a su actividad básica. Por esta razón, complementan sus propios esfuerzos con empresas expertas en distribución y comercialización, que concentran su actividad en estos aspectos y logran un cubrimiento geográfico y de zonas más eficiente; asimismo, cuentan con redes de múltiples contactos o conocimiento de tiendas y locales, por lo que tienen un mayor alcance y posibilidades de expansión y colocación del producto.
            br
    ...
    .row.justify-content-center.mt-4
      p Por otro lado, desde el punto de vista estructural, las empresas de alimentos no cuentan con sistemas de bodegas y almacenamiento adecuados en capacidad y condiciones de espacio para adecuar productos en grandes escalas. Esto se puede suplir con algunos agentes externos, como los distribuidores mayoristas, quienes cuentan con flotas de transporte de amplia capacidad y adecuadas a las necesidades de los productos (refrigerados o congelados, paletizados, etc.), garantizando que estos estén seguros en su compromiso de vincularlos a otros dentro de la cadena, o a los clientes y consumidores si se tratase de abastecer cadenas de grandes superficies.
      p Desde el punto de vista gerencial y estratégico, una empresa productora de alimentos puede establecer sus objetivos de cubrimiento y colección de producto y ubicación mucho más fácil por medio de estos canales de distribución.             
    ...
    .row.justify-content-center
      .col-lg-7.mt-3
        ImagenInfograficaB.color-acento-botones
          ...
          div(x="68%" y="12%" tooltip="" numero="1")
            h5 Distribución física
            p Es la función que el operador externo de la empresa debe cumplir para almacenar transitoriamente y transportar los productos.

          div(x="80.5%" y="27.5%" tooltip="" numero="2")
            h5 Relacionamiento
            p Busca identificar posibles clientes, establecer comunicación, negociar con clientes.

          div(x="86%" y="49.5%" tooltip="" numero="3")
            h5 Comunicación e Información
            p Los canales de distribución deben recopilar información respecto al comportamiento del mercado, sus niveles de compra, preferencias de consumo, presentaciones más solicitadas, tipos de clientes, entre otros múltiples aspectos; así mismo, deben divulgar las condiciones para la venta de producto, listas de precios, cantidades mínimas a vender por tipo de cliente, promociones y sus periodos de validez, aspectos que serán de permanente coordinación entre la empresa y los canales.

          div(x="81.5%" y="75%" tooltip="" numero="4")
            h5 Promoción
            p Diseñar, realizar publicidad, promover de manera atractiva al mercado las nuevas ofertas y promociones de productos.

          div(x="66.7%" y="93.5%" tooltip="" numero="5")
            h5 Adecuación 
            p De acuerdo con el tipo de comprador, los distribuidores deben facilitar la adecuación del producto, de manera que favorezca el servicio y la selección o movilidad de estos. 

          div(x="36.7%" y="93.5%" tooltip="" numero="6")
            h5 Negociación
            p Asumir los acuerdos comerciales que considere necesarios para la venta efectiva; lograr contratos de suministro periódico con el fin de reducir las transacciones y garantizando las ventas futuras.     

          div(x="20.5%" y="75%" tooltip="" numero="7")
            h5 Financiación 
            p Los distribuidores, en conformidad a su capacidad económica y de fondos, podrán otorgar plazos a sus clientes.  

          div(x="16%" y="49.5%" tooltip="" numero="8")
            h5 Manejo de imagen y calidad
            p Los distribuidores deberán garantizar la calidad de los productos, en aras de consolidar la imagen de marca, así como prever la buena manipulación de los productos para que no se altere su presentación e idoneidad para el consumo.     

          div(x="21.5%" y="27.5%" numero="9")
            h5 Asumir riesgos
            p Los canales deben asumir los riesgos asociados al desarrollo del trabajo, derivados de la manipulación, transporte, y custodia de los productos; por tanto, deben contar con esquemas de aseguramiento de los productos, además de capacitar permanentemente al personal y sus clientes sobre las condiciones adecuadas para la operación.                                               
    ...
    .row.mb-5
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/YzMfN8fHlP8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-5
        img(src='@/assets/curso/temas/tema1/t1-17.svg', alt='Texto que describa la imagen')
